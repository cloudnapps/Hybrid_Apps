...
app.directive('ionicCityPicker', ['$ionicPopup', '$timeout', '$ionicScrollDelegate', '$ionicModal', 'ReceiverApi',
  function ($ionicPopup, $timeout, $ionicScrollDelegate, $ionicModal, ReceiverApi) {
    return {
      restrict: 'AE',
